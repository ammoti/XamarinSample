    ...
    public class NavigationService : INavigationService
    {
        ...
        protected virtual async Task InternalNavigateToAsync(Type viewModelType, object parameter)
        {
            ...
            else if (CurrentApplication.MainPage is MainView)
            {
                ...
                if (mainPage.Detail is HealthCareNavigationPage navigationPage)
                {
                ...
                {
                    navigationPage = new HealthCareNavigationPage(page);
            ...
            {
                var navigationPage = CurrentApplication.MainPage as HealthCareNavigationPage;
                ...
                {
                    CurrentApplication.MainPage = new HealthCareNavigationPage(page);
                }
            }
        ...
        private void CreatePageViewModelMappings()
        {
            ...
            _mappings.Add(typeof(ChartViewModel), typeof(ChartView));
            _mappings.Add(typeof(ContactViewModel), typeof(Contact));
            _mappings.Add(typeof(SampleViewModel), typeof(SampleView));
        }
    }
}
